...
async function main() {
  ...
  // Open the new week: Sunday 23.8.2026
  // In Israel timezone (UTC+3), Sunday 23.8.2026 00:00 is 2026-08-22T21:00:00Z
  const newWeek = new Date("2026-08-22T21:00:00.000Z");
  ...
  console.log("\nDone! Constraints window is now open for 23.8 - 30.8");
  console.log("Day 0 (23.8) is blocked - already scheduled.");
}
